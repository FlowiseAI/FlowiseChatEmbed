    ...
    return (
        <button
            ...
            class={
                ...
                (props.size === 'large' ? ' w-32 h-32' : ' w-12 h-12') // large: from 16 to 32
            }
            style={{
            ...
            <Show when={isNotDefined(props.customIconSrc)} keyed>
                <svg
                    ...
                    class={
                        ...
                        (props.size === 'large' ? ' w-18' : ' w-7') // large: from 9 to 18
                    }
                >
            ...
            <Show when={props.customIconSrc}>
                <img
                    ...
                    class={'rounded-full object-cover' +
                        (props.isBotOpened ? 'scale-0 opacity-0' : 'scale-100 opacity-100') +
                        (props.size === 'large' ? ' w-18 h-18' : ' w-7 h-7')} // large: from 9 to 18
