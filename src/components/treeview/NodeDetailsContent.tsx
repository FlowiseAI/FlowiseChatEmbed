...
import { removeFlowiseCredentialId } from './workflowUtils';
...
export const NodeIcon = (props: { name: string; apiHost?: string; size?: number; borderRadius?: string; bgColor?: string }) => {
...
export const jsonBlockStyle: Record<string, string> = {
...
export const NodeDetailsContent = (props: NodeDetailsContentProps) => {
  ...
  const metrics = () => getMetrics(cleanedData());
        ...
        {(condition: any, index) => (
          <div style={{ border: '1px solid #4CAF50', 'border-radius': '6px', padding: '8px 12px', 'margin-bottom': '6px' }}>
            <div style={{ display: 'flex', 'justify-content': 'space-between', 'align-items': 'center' }}>
              ...
              <span style={badgeBaseStyle('#E8F5E9', '#2E7D32')}>Fulfilled</span>
            </div>
  ...
  return (
    <>
      {/* Header: node icon + label + metrics */}
      <div
        style={{
          display: 'flex',
